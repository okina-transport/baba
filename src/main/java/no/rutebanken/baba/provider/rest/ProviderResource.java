    ...
    public List<Provider> syncProviders(List<Provider> providers) {
        ...
        providers.forEach(p -> {
            ...
            if(p.chouetteInfo != null){
                providerRepository.updateChouetteInfo(p.chouetteInfo.user, p.chouetteInfo.codeIdfm, p.chouetteInfo.nameNetexStop, p.chouetteInfo.nameNetexOffre, p.chouetteInfo.gtfsPrefixExport);
            }
        });
        return providers;
    }
