...
class KeycloakIamServiceTest {
    ...
    void testMapResponsibilityRoleAssignmentToKeycloakRoleAssignment() {
        ...
        assertEquals(role.getPrivateCode(), keycloakRoleAssignment.getRole());
        assertEquals(organisation.getPrivateCode(), keycloakRoleAssignment.getOrganisation());
        ...
        assertEquals("KVE:TopographicPlace:05", keycloakRoleAssignment.getAdministrativeZone());
    }
    ...
    void testGeneratePassword() {
        ...
        assertNotEquals(password.toLowerCase(), password);
        assertNotEquals(password.toUpperCase(), password);
    }
